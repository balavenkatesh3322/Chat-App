! function() {
    ...
    var app = angular.module("ngImgCrop", []);
    app.factory("cropAreaCircle", ["cropArea", function(e) {
        var t = function() {
    ...
    app.factory("cropAreaSquare", ["cropArea", function(e) {
        var t = function() {
    ...
    app.factory("cropArea", ["cropCanvas", function(e) {
        var t = function(t, i) {
    ...
    app.factory("cropCanvas", [function() {
        var e = [
                [-.5, -2],
                [-3, -4.5],
                [-.5, -7],
    ...
    }]), app.factory("cropHost", ["$document", "cropAreaCircle", "cropAreaSquare", "cropEXIF", function(e, t, i, r) {
        var s = function(e) {
    ...
    app.factory("cropPubSub", [function() {
        return function() {
            var e = {};
    ...
    app.directive("imgCrop", ["$timeout", "cropHost", "cropPubSub", function(e, t, i) {
        return {
            restrict: "E",
            scope: {
                image: "=",
