//var app = angular.module('ShoreRoleMasterApp', ['angularUtils.directives.dirPagination']);
					app.controller('ShoreRoleMasterCtrl', function($scope, Connectivity,$http, $rootScope, $window, $location, $filter,$timeout){							
						$scope.currentPage = 1; 	
						$scope.hidebody = true;
...
//					$scope.pageSize = 25;
					...
					$http({
					    url: "/retrieve_shore_role_master/",
					    method: 'GET',
