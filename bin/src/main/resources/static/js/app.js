var app = angular.module('mackApp', ['ngRoute','ngResource', 'ngImgCrop', 'ngAnimate', 'angularUtils.directives.dirPagination', 'kendo.directives', 'toaster','ui.bootstrap','countTo','ngImageCompress']);
...
app.config(function($routeProvider){
    $routeProvider
        ...
        .when('/Forms',{
            templateUrl: '/views/Forms/mack-s_module.html',
            controller: 'systemNotificationCtrl'
        })
        .when('/Taskmanager',{
            templateUrl: '/views/TaskManager/Taskmodule.html',
            controller: 'systemNotificationCtrl'
        })
        .when('/Master',{
            templateUrl: '/views/Master/mastermodule.html',
            controller: 'systemNotificationCtrl'
        })
        .when('/Security',{
            templateUrl: '/views/Security/securitymodule.html',
            controller: 'systemNotificationCtrl'
        })
        .when('/Edoc',{
            templateUrl: '/views/E-doc/edocs.html',
            controller: 'systemNotificationCtrl'
        })
        .when('/Inspection',{
            templateUrl: '/views/Inspection/hseqmodule.html',
            controller: 'systemNotificationCtrl'
        })
        .when('/Reports',{
	   ...
	   .when('/ModuleCreation',{
        ...
        .when('/activemqreceiver/:id*',{
            ...
            controller: 'activemqDetailReceiverCtrl'
           	...
           	templateUrl : '/views/communications/communication.html',
           	controller: 'systemNotificationCtrl'    
    	}).when('/NearMissShare',{
